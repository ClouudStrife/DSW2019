 ...
 * @author Guga Bot
 */
@WebServlet(name = "getLocadorasServlet", urlPatterns = {"/listarLocadoras"})
public class getLocadorasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("listaLocadorasJSP.jsp").forward(request, response);
